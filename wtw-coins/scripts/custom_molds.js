WTW_COINS.prototype.addMoldMyCustomMold = function(zmoldname, zmolddef, zlenx, zleny, zlenz) {
	let zmold;
	try {
		...
		WTW.log("plugins:wtw-coins:scripts-custom_molds.js-addMoldMyCustomMold=" + ex.message);
	}
	return zmold;
}
